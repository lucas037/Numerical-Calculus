...
public class GaussJacobi {
    ...
    public GaussJacobi(Matrix matrix, Matrix resultMatrix, Matrix chuteInicial, double e) {
        this.matrix = matrix;
    ...
    public void calcularIteracao() {
        ...
        for (int i = 0; i < result.length; i++) {
            chute[0][i] = result[i]; // novos "chutes" para o próximo se baseiam no resultado da iteração anterior.
        }
